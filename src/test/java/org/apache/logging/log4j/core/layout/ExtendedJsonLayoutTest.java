...
public class ExtendedJsonLayoutTest {
    ...
    private void testAllFeatures(final boolean locationInfo, final boolean compact, final boolean eventEol,
                                 final boolean includeContext, final boolean contextMapAslist, final boolean includeStacktrace, final boolean stackTraceAsString, final boolean objectMessageAsJsonObject, String jsonAdapterClass)
            throws Exception {
        ...
        Log4jJsonObjectMapper mapper = new Log4jJsonObjectMapper(contextMapAslist, includeStacktrace, stackTraceAsString, objectMessageAsJsonObject);
    ...
    public void testLayoutLoggerName() throws Exception {
        ...
        Log4jJsonObjectMapper mapper = new Log4jJsonObjectMapper(propertiesAsList, true, true, false);
        mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
        final Log4jLogEvent actual = mapper.readValue(str, Log4jLogEvent.class);
    ...
    public void testLocationOffCompactOffMdcOff() throws Exception {
        this.testAllFeatures(false, false, false, false, false, true, false, false, ExtendedJsonAdapter.class.getName());
    }

    @Test
    public void testLocationOnCompactOnMdcOn() throws Exception {
        this.testAllFeatures(true, true, false, true, false, true, false, false, ExtendedJsonAdapter.class.getName());
    }

    @Test
    public void testLocationOnCompactOnEventEolOnMdcOn() throws Exception {
        this.testAllFeatures(true, true, true, true, false, true, false, false, ExtendedJsonAdapter.class.getName());
    }

    @Test
    public void testLocationOnCompactOnEventEolOnMdcOnMdcAsList() throws Exception {
        this.testAllFeatures(true, true, true, true, true, true, false, false, ExtendedJsonAdapter.class.getName());
    }

    @Test
    public void testExcludeStacktrace() throws Exception {
        this.testAllFeatures(false, false, false, false, false, false, false, false, ExtendedJsonAdapter.class.getName());
    }
