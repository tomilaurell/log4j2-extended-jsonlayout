...
public class ExtendedJsonLayout extends AbstractJacksonLayout {
    ...
    public static class Builder<B extends Builder<B>> extends AbstractJacksonLayout.Builder<B>
        ...
        @PluginBuilderAttribute
        private boolean objectMessageAsJsonObject = false;
        ...
        public ExtendedJsonLayout build() {
            ...
            return new ExtendedJsonLayout(getConfiguration(), locationInfo, properties, encodeThreadContextAsList, isComplete(),
                    isCompact(), getEventEol(), headerPattern, footerPattern, getCharset(), includeStacktrace, stackTraceAsString, objectMessageAsJsonObject, jsonAdapterClassName);
        }
    ...
    protected ExtendedJsonLayout(final Configuration config, final boolean locationInfo, final boolean properties,
                                 ...
                                 final String footerPattern, final Charset charset, final boolean includeStacktrace, final boolean stackTraceAsString, final boolean objectMessageAsJsonObject, final String jsonExtenderClass) {
        super(config, getObjectWriter(encodeThreadContextAsList, includeStacktrace, stackTraceAsString, objectMessageAsJsonObject, locationInfo, properties, compact),
    ...
    static protected ObjectWriter getObjectWriter(boolean encodeThreadContextAsList, boolean includeStacktrace, boolean stackTraceAsString, boolean objectMessageAsJsonObject, boolean locationInfo, boolean properties, boolean compact) {
        ObjectWriter writer = new JacksonFactory.JSON(encodeThreadContextAsList, includeStacktrace, stackTraceAsString, objectMessageAsJsonObject).newWriter(
    ...
    public static ExtendedJsonLayout createDefaultLayout() {
        return new ExtendedJsonLayout(new DefaultConfiguration(), false, false, false, false, false, false,
                DEFAULT_HEADER, DEFAULT_FOOTER, StandardCharsets.UTF_8, true, true, false, DEFAULT_JSON_EXTENDER_CLASS);
    }
